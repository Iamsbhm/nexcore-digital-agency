    ...
    <div className="relative z-10 px-4 md:px-8 max-w-7xl mx-auto pt-8 pb-24 space-y-28">
      ...
      >
        ...
        <p className="text-sm text-white/40 max-w-xl mx-auto leading-relaxed">
          Pixel Advance Digital was founded with one belief: businesses deserve digital experiences as extraordinary as their ambitions.
        </p>
      </motion.div>
      ...
      <div className="grid md:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <p className="text-sm text-white/40 leading-relaxed">
            Founded in 2018, Pixel Advance Digital started as a two-person design studio focused on brand identity. Over seven years, we've grown into a full-spectrum digital agency with specialists across design, engineering, AI automation, and growth strategy.
          </p>
          <p className="text-sm text-white/40 leading-relaxed">
