  ...
  return (
    <div className="min-h-screen bg-[#06080e] text-slate-300 font-sans selection:bg-[#c5a059]/30 selection:text-[#f7eedb] relative">
      ...
      >
        ...
        <div className="relative z-10 flex-1 flex items-start pl-20 md:pl-28 lg:pl-40 pr-6 md:pr-12 lg:pr-16 max-w-8xl mx-auto w-full pb-12" style={{ paddingTop: '65px' }}>
